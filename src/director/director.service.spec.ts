...
describe('DirectorService', () => {
    ...
    describe('create', () => {
        it('should create a new director', async () => {
            ...
            jest.spyOn(mockDirectorRepository, 'save').mockResolvedValue(
                createDirectorDto,
            );
    ...
    describe('findAll', () => {
        it('should return an array of directors', async () => {
            ...
            jest.spyOn(mockDirectorRepository, 'find').mockResolvedValue(
                directors,
            );
    ...
    describe('findOne', () => {
        it('should return a single director by id', async () => {
            ...
            jest.spyOn(mockDirectorRepository, 'findOne').mockResolvedValue(
    ...
    describe('update', () => {
        it('should update a director by id', async () => {
            ...
            jest.spyOn(mockDirectorRepository, 'findOne').mockResolvedValueOnce(
                existingDirector,
            );
            jest.spyOn(mockDirectorRepository, 'findOne').mockResolvedValueOnce(
                updatedDirector,
    ...
    describe('remove', () => {
        ...
        it('should throw NotFoundException if director does not exist', async () => {
            ...
            expect(directorService.remove(1)).rejects.toThrow(
                NotFoundException,
            );
        });
    });
