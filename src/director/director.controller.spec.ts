...
describe('DirectorController', () => {
    ...
    describe('findAll', () => {
        it('should call findAll method from DirectorService', async () => {
            ...
            jest.spyOn(mockDirectorService, 'findAll').mockResolvedValue(
                result,
            );
    ...
    describe('findOne', () => {
        it('should call findOne method from DirectorService with correct ID', () => {
            ...
            jest.spyOn(mockDirectorService, 'findOne').mockResolvedValue(
                result,
            );
    ...
    describe('create', () => {
        it('should call create method from DirectorServic with correct DTO', () => {
            const createDirectorDto = {
                name: 'code factory',
            };
            const result = { id: 1, name: 'code factopry' };
    ...
    describe('update', () => {
        it('should call update method from DirectorService with correct Id and DTO', () => {
            ...
            expect(controller.update(1, updateDirectorDto)).resolves.toEqual(
                result,
            );
